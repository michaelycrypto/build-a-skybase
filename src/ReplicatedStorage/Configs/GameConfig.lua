...
local GameConfig = {
	...
	DataStore = {
		PlayerData = {
			DataStoreVersion = "PlayerData_v95", -- Keep in sync with PlayerDataStoreService (updated for 4-tier system)
	...
	Worlds = {
		...
		DataStoreVersion = "PlayerOwnedWorlds_v84" -- Updated for multi-world support
	},
