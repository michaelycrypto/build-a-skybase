...
local GameConfig = {
	...
	DataStore = {
		PlayerData = {
			DataStoreVersion = "PlayerData_v111", -- Keep in sync with PlayerDataStoreService (updated for 4-tier system)
	...
	Worlds = {
		...
		DataStoreVersion = "PlayerOwnedWorlds_v101" -- Updated for multi-world support
	},
