...
local GameConfig = {
	...
	DataStore = {
		PlayerData = {
			DataStoreVersion = "PlayerData_v94", -- Keep in sync with PlayerDataStoreService (updated for 4-tier system)
	...
	Worlds = {
		...
		DataStoreVersion = "PlayerOwnedWorlds_v80" -- Updated for multi-world support
	},
